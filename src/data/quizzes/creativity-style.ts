  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: '완벽한 구조를 체계적으로 구축했을 때', value: 'structure' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '완벽하게 구성된 건축물', value: 'perfect-architecture' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '체계적이고 논리적인 구조 설계', value: 'logical-design' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '구조와 완성도의 저울', value: 'structure-balance' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '체계적으로 구축하는 건축 과정', value: 'building-process' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '체계적이고 완벽한 건축물', value: 'perfect-building' },
        {
          text: '협력과 소통이 가득한 공연',
...
하지만 협력하는 서커스단도 너무 의존적이면 독립성이 부족할 수 있듯이, 당신도 때로는 의존성이나 결정 지연이 있을 수 있어요. 가끔은 협력하는 서커스단도 솔로 공연(독립적 작업)이 필요하다는 걸 잊지 마세요!`,
        ...
        goodMatchReasons: [
          ...
          '체계적인 건축가 같은 분석가: 함께 체계적이고 협력적인 작품을 만들 수 있어요',
        ],
        badMatchReasons: [
...
하지만 혁신적인 보석공도 너무 기존에 의존하면 새로움이 부족할 수 있듯이, 당신도 때로는 완전히 새로운 것을 처음부터 만드는 능력이 부족할 수 있어요. 가끔은 혁신적인 보석공도 새로운 원석(완전히 새로운 아이디어)을 발견해보는 것도 좋을 것 같아요!`,
        ...
        goodMatchReasons: [
          '체계적인 건축가 같은 분석가: 당신의 조합 능력이 상대방의 체계성과 조화를 이룰 수 있어요',
