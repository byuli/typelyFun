  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"모든 사람과 균형 있게 소통해!"', value: 'balanced' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"공감하며 감정적 지원을 제공해!"', value: 'empathetic' },
    ...
    },
    {
      ...
      options: [
        { text: '"직접적으로 문제를 해결하려 해!"', value: 'confrontational' },
        { text: '"중재자 역할을 하며 양쪽을 조율해!"', value: 'mediator' },
    ...
    },
    {
      ...
      options: [
        { text: '"적극적으로 피드백을 요청하고 받아들여!"', value: 'open' },
    ...
    },
    {
      ...
      options: [
        { text: '"적극적으로 도움을 제안하고 실행해!"', value: 'proactive' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"신중하게 준비한 후 도전해!"', value: 'cautious' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"조화로운 관계를 만들어!"', value: 'harmonious' },
...
하지만 달도 때로는 너무 조용해서 그림자에 가려질 수 있듯이, 당신도 가끔은 자신의 의견을 표현하지 못하거나 새로운 기회를 놓칠 수 있어요. 가끔은 달도 태양(외향성)의 밝은 에너지를 배워보는 것이 좋을 것 같아요!`,
        ...
        goodMatches: ['태양 같은 외향적 리더', '저울 같은 균형잡힌 조화가'],
        badMatches: ['무지개 같은 적응적 유연가'],
        goodMatchReasons: [
          '태양 같은 외향적 리더: 당신의 깊이와 상대방의 활발함이 아름다운 조화를 만들어요',
          '저울 같은 균형잡힌 조화가: 함께 신중하고 균형있는 관계를 만들 수 있어요',
        ],
        badMatchReasons: [
...
하지만 무지개도 때로는 너무 빨리 변해서 본래 색깔을 잃을 수 있듯이, 당신도 가끔은 진정한 자아를 잃거나 일관성이 부족해 보일 수 있어요. 가끔은 무지개도 하나의 색깔(일관성)을 유지해보는 것이 좋을 것 같아요!`,
        ...
        goodMatchReasons: [
          ...
          '저울 같은 균형잡힌 조화가: 함께 다양한 상황에서 조화롭게 적응할 수 있어요',
        ],
        badMatchReasons: [
