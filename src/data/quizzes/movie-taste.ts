  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: '깊이 있는 생각과 성찰의 시간', value: 'contemplative' },
    ...
    },
    {
      ...
      options: [
        { text: '모험적이고 도전적인 영화 탐험가', value: 'adventurer' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '예술성과 대중성 사이의 균형', value: 'balance' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '예술관처럼 완벽한 작품성', value: 'masterpiece' },
