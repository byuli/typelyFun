  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: '☀️ "분위기를 바꿔보자!"', value: 'mood-changer' },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { text: '🕊️ "부드럽게 감정을 배려하며!"', value: 'gentle' },
    ...
    },
    {
      ...
      options: [
        { text: '⚔️ "정면 승부! 확실하게 해결!"', value: 'confrontational' },
        { text: '🕊️ "평화롭게 서로 이해하며!"', value: 'peaceful' },
        { text: '⚖️ "공정하고 객관적으로!"', value: 'objective' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '🏔️ "산 같은 신중형!"', value: 'mountain' },
...
하지만 번개도 때로는 너무 강렬해서 상대방을 놀라게 할 수 있듯이, 당신도 가끔은 다른 사람의 감정을 놓치거나 너무 직접적이어서 상처를 줄 수 있어요. 가끔은 번개도 구름(부드러움) 속에서 은은하게 빛나는 것도 좋을 것 같아요!`,
        ...
        goodMatches: ['🌸 봄바람 같은 공감 소통가', '🏔️ 산 같은 논리 소통가'],
        badMatches: ['🎨 무지개 같은 창의 소통가'],
        goodMatchReasons: [
          '🌸 봄바람 같은 공감 소통가: 당신의 효율성과 상대방의 따뜻함이 균형을 이룰 수 있어요',
          '🏔️ 산 같은 논리 소통가: 함께 체계적이고 명확한 소통을 할 수 있어요',
        ],
        badMatchReasons: [
...
하지만 무지개도 때로는 너무 화려해서 집중하기 어려울 수 있듯이, 당신도 가끔은 너무 창의적이어서 핵심을 놓치거나 체계성이 부족할 수 있어요. 가끔은 무지개도 하나의 색(일관성)에 집중해보는 것도 좋을 것 같아요!`,
        ...
        goodMatchReasons: [
          ...
          '🏔️ 산 같은 논리 소통가: 당신의 창의성과 상대방의 논리성이 조화를 이룰 수 있어요',
        ],
        badMatchReasons: [
