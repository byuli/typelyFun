  ...
  questions: [
    {
      ...
      options: [
        { text: '"3개월 전부터 상세한 일정표 작성!"', value: 'planner' },
        {
    ...
    },
    {
      ...
      options: [
        { text: '새로운 곳을 탐험하고 모험하는 것', value: 'explore' },
        { text: '편안하게 휴식하고 여유를 즐기는 것', value: 'relax' },
        { text: '박물관이나 문화재를 관람하는 것', value: 'museum' },
        { text: '자연 속에서 산책이나 등산하는 것', value: 'hiking' },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"자연 속에서 머물 수 있는 게 최고야!"', value: 'natural' },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        { text: '모험적이고 도전적인 여행자', value: 'adventurous' },
...
하지만 백팩커도 너무 즉흥적이면 위험할 수 있듯이, 당신도 때로는 너무 많은 위험을 감수하거나 준비 부족으로 어려움을 겪을 수 있어요. 가끔은 백팩에 지도(기본 계획)를 넣어보는 것도 좋을 것 같아요!`,
        ...
        goodMatches: ['스위스 시계 같은 계획가', '리조트 같은 안정가'],
        badMatches: ['히말라야 같은 자연가'],
        goodMatchReasons: [
          '스위스 시계 같은 계획가: 상대방의 계획성이 당신의 즉흥성에 안정감을 제공해요',
...
하지만 히말라야도 너무 높으면 산소가 부족할 수 있듯이, 당신도 때로는 너무 이상적이거나 현실과의 괴리를 느낄 수 있어요. 가끔은 히말라야에서 내려와서 현실(도시)도 경험해보는 것도 좋을 것 같아요!`,
        ...
        goodMatchReasons: [
          '스위스 시계 같은 계획가: 함께 체계적이고 의미 있는 여행을 계획할 수 있어요',
