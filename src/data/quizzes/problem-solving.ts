...
export const problemSolvingQuiz: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { text: '"장단점을 분석하여 가장 합리적인 방법을 선택해!"', value: 'analytical' },
    ...
    },
    {
      ...
      options: [
        { text: '"정보를 분류하고 체계적으로 정리해!"', value: 'analytical' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"다른 사람들의 관점에서 원인을 분석해!"', value: 'collaborative' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"다양한 관점에서 시스템을 바라봐!"', value: 'collaborative' },
        { text: '"실제로 시스템을 조작해보면서 이해해!"', value: 'experimental' },
      ],
    },
    {
      question: '문제 해결 과정에서 의견이 갈릴 때 당신은?',
      options: [
        { text: '"각 의견의 장단점을 분석하여 비교해!"', value: 'analytical' },
