  ...
  questions: [
    {
      ...
      options: [
        { text: '🏃‍♀️ "운동이나 신체 활동으로 스트레스를 날려버려!"', value: 'physical' },
        { text: '🧘‍♂️ "명상이나 호흡 운동으로 마음을 진정시켜!"', value: 'mental' },
    ...
    },
    {
      ...
      options: [
        { text: '🚶‍♀️ "산책이나 조깅으로 몸을 움직여!"', value: 'physical' },
    ...
    },
    {
      ...
      options: [
        { text: '🤸‍♀️ "스트레칭이나 요가로 몸을 이완시켜!"', value: 'physical' },
        { text: '🌬️ "깊은 호흡이나 명상으로 긴장을 풀어줘!"', value: 'mental' },
    ...
    },
    {
      ...
      options: [
        { text: '☀️ "밖에 나가서 햇볕을 쬐고 신선한 공기를 마셔!"', value: 'physical' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '🕯️ "마음의 여유를 찾기 위해 명상이나 휴식을 취해!"', value: 'mental' },
    ...
    },
    {
      ...
      options: [
        { text: '🚶‍♂️ "짧은 산책이나 스트레칭으로 기운을 되찾아!"', value: 'physical' },
    ...
    },
    {
      ...
      options: [
        { text: '🏃‍♂️ "가벼운 운동으로 몸을 깨우고 활력을 되찾아!"', value: 'physical' },
    ...
    },
    {
      ...
      options: [
        { text: '🛏️ "편안한 환경을 만들고 수면 루틴을 정해!"', value: 'physical' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '🧘‍♀️ "마음의 안정을 찾고 식사에 집중해!"', value: 'mental' },
    ...
    },
    {
      ...
      options: [
        { text: '🏃‍♀️ "운동으로 스트레스를 발산해!"', value: 'physical' },
        { text: '🧘‍♂️ "마음을 진정시키고 인내심을 길러!"', value: 'mental' },
    ...
    },
    {
      ...
      options: [
        { text: '🌬️ "깊은 호흡이나 명상으로 마음을 진정시켜!"', value: 'mental' },
        { text: '🗣️ "신뢰할 수 있는 사람과 불안한 감정을 나눠!"', value: 'social' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '🧘‍♀️ "명상이나 마음챙김 기법을 연습해!"', value: 'mental' },
...
하지만 운동장도 때로는 너무 활동적이어서 조용한 휴식이 필요할 수 있듯이, 당신도 가끔은 과도한 활동으로 피로가 쌓이거나 정신적인 휴식을 놓칠 수 있어요. 가끔은 운동장도 조용한 도서관(정신적 휴식)이 되어보는 것이 좋을 것 같아요!`,
        ...
        goodMatches: ['🧘‍♀️ 호수 같은 정신안정가', '🎨 놀이터 같은 취미몰입가'],
        badMatches: ['👥 카페 같은 사회교류가'],
        goodMatchReasons: [
          '🧘‍♀️ 호수 같은 정신안정가: 당신의 활동적 에너지와 상대방의 평온함이 완벽한 균형을 만들어요',
...
하지만 호수도 때로는 너무 고요해서 정체될 수 있듯이, 당신도 가끔은 지나치게 내향적이 되거나 사회적 교류를 피하게 될 수 있어요. 가끔은 호수도 바다(사교성)와 만나서 활력을 얻는 것이 좋을 것 같아요!`,
        ...
        goodMatches: ['🏃‍♀️ 운동장 같은 신체활동가', '👥 카페 같은 사회교류가'],
        badMatches: ['🎨 놀이터 같은 취미몰입가'],
        goodMatchReasons: [
          '🏃‍♀️ 운동장 같은 신체활동가: 당신의 정신적 평온과 상대방의 활동적 에너지가 완벽한 조화를 이뤄요',
...
하지만 카페도 때로는 너무 시끄러워서 개인적인 고요함이 필요할 수 있듯이, 당신도 가끔은 다른 사람에게만 의존하거나 혼자만의 시간을 갖지 못할 수 있어요. 가끔은 카페도 조용한 도서관(혼자만의 시간)이 되어보는 것이 좋을 것 같아요!`,
        ...
        goodMatches: ['🧘‍♀️ 호수 같은 정신안정가', '🎨 놀이터 같은 취미몰입가'],
        badMatches: ['🏃‍♀️ 운동장 같은 신체활동가'],
        goodMatchReasons: [
          '🧘‍♀️ 호수 같은 정신안정가: 당신의 따뜻한 소통과 상대방의 깊은 평온함이 아름다운 조화를 만들어요',
          '🎨 놀이터 같은 취미몰입가: 함께 즐거운 활동을 하며 소통할 수 있어요',
        ],
        badMatchReasons: [
          '🏃‍♀️ 운동장 같은 신체활동가: 너무 개인적이고 활동 중심적인 방식과 맞지 않을 수 있어요',
        ],
        recommendations: [
...
하지만 놀이터도 때로는 너무 재미에만 빠져서 현실을 잊을 수 있듯이, 당신도 가끔은 현실 도피 수단으로만 사용하거나 중요한 문제들을 미루게 될 수 있어요. 가끔은 놀이터도 교실(현실적 해결)이 되어보는 것이 좋을 것 같아요!`,
        ...
        goodMatches: ['👥 카페 같은 사회교류가', '🏃‍♀️ 운동장 같은 신체활동가'],
        badMatches: ['🧘‍♀️ 호수 같은 정신안정가'],
        goodMatchReasons: [
          '👥 카페 같은 사회교류가: 당신의 재미있는 활동과 상대방의 따뜻한 소통이 즐거운 시너지를 만들어요',
          '🏃‍♀️ 운동장 같은 신체활동가: 함께 활동적이고 재미있는 취미를 즐길 수 있어요',
        ],
        badMatchReasons: [
          '🧘‍♀️ 호수 같은 정신안정가: 너무 조용하고 성찰적인 방식과 활발한 취미 활동이 맞지 않을 수 있어요',
        ],
        recommendations: [
