  ...
  questions: [
    {
      ...
      options: [
        { text: '"직접 만지고 경험하면서 배워!"', value: 'hands-on' },
    ...
    },
    {
      ...
      options: [
        { text: '"실제로 어떻게 사용하는지!"', value: 'application' },
    ...
    },
    {
      ...
      options: [
        { text: '"실습할 수 있는 활동적인 공간!"', value: 'active' },
    ...
    },
    {
      ...
      options: [
        { text: '"직접 써보고 연습문제 풀기!"', value: 'practice' },
        { text: '"교재를 반복해서 읽기!"', value: 'reading' },
        { text: '"스터디 그룹으로 함께 공부!"', value: 'study-group' },
        { text: '"마인드맵과 다이어그램 그리기!"', value: 'mind-map' },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"중요한 부분에 색칠하고 표시해!"', value: 'highlight' },
      ],
    },
    {
      question: '새로운 언어를 배운다면?',
      options: [
        { text: '"바로 말하고 실제 상황에서 써봐!"', value: 'speak-practice' },
    ...
    },
    {
      ...
      options: [
        { text: '"만들면서 아이디어를 발전시켜!"', value: 'create-while-thinking' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"이미지와 연결해서 기억해!"', value: 'visual-memory' },
      ],
    },
    {
      question: '온라인 강의를 들을 때?',
      options: [
        { text: '"중간중간 멈춰서 따라해봐!"', value: 'pause-and-practice' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"계획을 세우고 조직해!"', value: 'organizer' },
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"시각적으로 정리해서 계획해!"', value: 'visual-planning' },
      ],
    },
    {
      ...
      options: [
        ...
        { text: '"차트나 그래프로 정리해!"', value: 'visual-review' },
      ],
    },
    {
      question: '학습 스타일을 한 마디로 표현하면?',
      options: [
        { text: '"도구를 다루는 장인 같은 스타일!"', value: 'craftsman' },
    ...
    },
    {
      ...
      options: [
        { text: '"실습실이나 워크숍!"', value: 'workshop' },
        { text: '"조용한 도서관이나 서재!"', value: 'library' },
        { text: '"스터디 카페나 세미나실!"', value: 'study-cafe' },
        { text: '"시각적 자료가 풍부한 멀티미디어 공간!"', value: 'multimedia-space' },
      ],
    },
  ],
...
하지만 마법사도 때로는 탑에만 있으면 현실과 거리가 멀어질 수 있듯이, 당신도 가끔은 너무 이론에만 치중하거나 실제 적용에서 어려움을 겪을 수 있어요. 가끔은 마법사도 탑에서 내려와서 현실 세계(실습)에서 마법을 써보는 것도 좋을 것 같아요!`,
        ...
        goodMatches: ['장인 같은 체험형 학습자', '무대 위의 소통형 학습자'],
        badMatches: ['예술가 같은 시각형 학습자'],
        goodMatchReasons: [
          '장인 같은 체험형 학습자: 당신의 이론과 상대방의 실습력이 완벽한 조합을 만들어요',
...
하지만 예술가도 때로는 너무 형태에만 집중해서 내용을 놓칠 수 있듯이, 당신도 가끔은 시각적 요소에만 의존하거나 추상적인 개념을 이해하는데 어려움을 겪을 수 있어요. 가끔은 예술가도 작품 뒤의 깊은 의미(개념적 이해)를 탐구해보는 것도 좋을 것 같아요!`,
        ...
        goodMatchReasons: [
          '장인 같은 체험형 학습자: 함께 창의적이고 실용적인 프로젝트를 할 수 있어요',
